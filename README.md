...
# Process Hollowing (Method 2 of 3)
...
6. Perform process hollowing with altering the host process's details, including its image, context, and instructions at the entry point
